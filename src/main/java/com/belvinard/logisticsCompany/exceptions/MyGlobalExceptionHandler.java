package com.belvinard.logisticsCompany.exceptions;
...
public class MyGlobalExceptionHandler {
    ...
    private ResponseEntity<?> buildResponse(String message, String errorType, WebRequest request, HttpStatus status) {
